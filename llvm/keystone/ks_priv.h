...
#define KS_MODE_ARM_MASK    (KS_MODE_ARM|KS_MODE_THUMB|KS_MODE_LITTLE_ENDIAN|KS_MODE_BIG_ENDIAN|KS_MODE_V8|KS_MODE_V4|KS_MODE_XSCALE|KS_MODE_V5|KS_MODE_V5E)
